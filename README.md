...
4. Ваш сайт будет доступен по адресу: `https://[ваш-username].github.io/dr/`
...
- В `vite.config.ts` указан `base: '/dr/'` - это путь к репозиторию на GitHub Pages. Если ваш репозиторий называется по-другому, измените это значение.
